import { Project, ExperienceItem, SkillCategory, Skill, AboutPacketField } from './types';
...
/**
 * About content as a decoded data packet (machine-voice fields), one human
 * statement, and the soft-skill trait matrix. Single source of truth for the
 * About "Origin" act; drives About.tsx (and informs the chatbot).
 */
export const ABOUT = {
  packet: [
